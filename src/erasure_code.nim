...
proc ec_init_tables*(k: cint; rows: cint; a: ptr cuchar; gftbls: ptr cuchar) {.cdecl,
    importc: "ec_init_tables", dynlib: libname.}
## *
...
proc ec_encode_data*(len: cint; k: cint; rows: cint; gftbls: ptr cuchar;
                    data: ptr ptr cuchar; coding: ptr ptr cuchar) {.cdecl,
    importc: "ec_encode_data", dynlib: libname.}
## *
...
proc ec_encode_data_sse*(len: cint; k: cint; rows: cint; gftbls: ptr cuchar;
                        data: ptr ptr cuchar; coding: ptr ptr cuchar) {.cdecl,
    importc: "ec_encode_data_sse", dynlib: libname.}
## *
##  @brief Generate or decode erasure codes on blocks of data.
## 
##  Arch specific version of ec_encode_data() with same parameters.
...
proc ec_encode_data_avx*(len: cint; k: cint; rows: cint; gftbls: ptr cuchar;
                        data: ptr ptr cuchar; coding: ptr ptr cuchar) {.cdecl,
    importc: "ec_encode_data_avx", dynlib: libname.}
## *
##  @brief Generate or decode erasure codes on blocks of data.
## 
##  Arch specific version of ec_encode_data() with same parameters.
...
proc ec_encode_data_avx2*(len: cint; k: cint; rows: cint; gftbls: ptr cuchar;
                         data: ptr ptr cuchar; coding: ptr ptr cuchar) {.cdecl,
    importc: "ec_encode_data_avx2", dynlib: libname.}
## *
...
proc ec_encode_data_base*(len: cint; srcs: cint; dests: cint; v: ptr cuchar;
                         src: ptr ptr cuchar; dest: ptr ptr cuchar) {.cdecl,
    importc: "ec_encode_data_base", dynlib: libname.}
## *
...
proc ec_encode_data_update*(len: cint; k: cint; rows: cint; vec_i: cint;
                           g_tbls: ptr cuchar; data: ptr cuchar;
                           coding: ptr ptr cuchar) {.cdecl,
    importc: "ec_encode_data_update", dynlib: libname.}
## *
...
proc ec_encode_data_update_sse*(len: cint; k: cint; rows: cint; vec_i: cint;
                               g_tbls: ptr cuchar; data: ptr cuchar;
                               coding: ptr ptr cuchar) {.cdecl,
    importc: "ec_encode_data_update_sse", dynlib: libname.}
## *
##  @brief Generate update for encode or decode of erasure codes from single source.
## 
##  Arch specific version of ec_encode_data_update() with same parameters.
...
proc ec_encode_data_update_avx*(len: cint; k: cint; rows: cint; vec_i: cint;
                               g_tbls: ptr cuchar; data: ptr cuchar;
                               coding: ptr ptr cuchar) {.cdecl,
    importc: "ec_encode_data_update_avx", dynlib: libname.}
## *
##  @brief Generate update for encode or decode of erasure codes from single source.
## 
##  Arch specific version of ec_encode_data_update() with same parameters.
...
proc ec_encode_data_update_avx2*(len: cint; k: cint; rows: cint; vec_i: cint;
                                g_tbls: ptr cuchar; data: ptr cuchar;
                                coding: ptr ptr cuchar) {.cdecl,
    importc: "ec_encode_data_update_avx2", dynlib: libname.}
## *
##  @brief Generate update for encode or decode of erasure codes from single source.
## 
...
proc ec_encode_data_update_base*(len: cint; k: cint; rows: cint; vec_i: cint;
                                v: ptr cuchar; data: ptr cuchar; dest: ptr ptr cuchar) {.
    cdecl, importc: "ec_encode_data_update_base", dynlib: libname.}
## *
...
proc gf_vect_dot_prod_sse*(len: cint; vlen: cint; gftbls: ptr cuchar;
                          src: ptr ptr cuchar; dest: ptr cuchar) {.cdecl,
    importc: "gf_vect_dot_prod_sse", dynlib: libname.}
## *
##  @brief GF(2^8) vector dot product.
## 
##  Does a GF(2^8) dot product across each byte of the input array and a constant
...
proc gf_vect_dot_prod_avx*(len: cint; vlen: cint; gftbls: ptr cuchar;
                          src: ptr ptr cuchar; dest: ptr cuchar) {.cdecl,
    importc: "gf_vect_dot_prod_avx", dynlib: libname.}
## *
##  @brief GF(2^8) vector dot product.
## 
##  Does a GF(2^8) dot product across each byte of the input array and a constant
...
proc gf_vect_dot_prod_avx2*(len: cint; vlen: cint; gftbls: ptr cuchar;
                           src: ptr ptr cuchar; dest: ptr cuchar) {.cdecl,
    importc: "gf_vect_dot_prod_avx2", dynlib: libname.}
## *
...
proc gf_2vect_dot_prod_sse*(len: cint; vlen: cint; gftbls: ptr cuchar;
                           src: ptr ptr cuchar; dest: ptr ptr cuchar) {.cdecl,
    importc: "gf_2vect_dot_prod_sse", dynlib: libname.}
## *
##  @brief GF(2^8) vector dot product with two outputs.
## 
##  Vector dot product optimized to calculate two ouputs at a time. Does two
...
proc gf_2vect_dot_prod_avx*(len: cint; vlen: cint; gftbls: ptr cuchar;
                           src: ptr ptr cuchar; dest: ptr ptr cuchar) {.cdecl,
    importc: "gf_2vect_dot_prod_avx", dynlib: libname.}
## *
##  @brief GF(2^8) vector dot product with two outputs.
## 
##  Vector dot product optimized to calculate two ouputs at a time. Does two
...
proc gf_2vect_dot_prod_avx2*(len: cint; vlen: cint; gftbls: ptr cuchar;
                            src: ptr ptr cuchar; dest: ptr ptr cuchar) {.cdecl,
    importc: "gf_2vect_dot_prod_avx2", dynlib: libname.}
## *
...
proc gf_3vect_dot_prod_sse*(len: cint; vlen: cint; gftbls: ptr cuchar;
                           src: ptr ptr cuchar; dest: ptr ptr cuchar) {.cdecl,
    importc: "gf_3vect_dot_prod_sse", dynlib: libname.}
## *
##  @brief GF(2^8) vector dot product with three outputs.
## 
##  Vector dot product optimized to calculate three ouputs at a time. Does three
...
proc gf_3vect_dot_prod_avx*(len: cint; vlen: cint; gftbls: ptr cuchar;
                           src: ptr ptr cuchar; dest: ptr ptr cuchar) {.cdecl,
    importc: "gf_3vect_dot_prod_avx", dynlib: libname.}
## *
##  @brief GF(2^8) vector dot product with three outputs.
## 
##  Vector dot product optimized to calculate three ouputs at a time. Does three
...
proc gf_3vect_dot_prod_avx2*(len: cint; vlen: cint; gftbls: ptr cuchar;
                            src: ptr ptr cuchar; dest: ptr ptr cuchar) {.cdecl,
    importc: "gf_3vect_dot_prod_avx2", dynlib: libname.}
## *
...
proc gf_4vect_dot_prod_sse*(len: cint; vlen: cint; gftbls: ptr cuchar;
                           src: ptr ptr cuchar; dest: ptr ptr cuchar) {.cdecl,
    importc: "gf_4vect_dot_prod_sse", dynlib: libname.}
## *
##  @brief GF(2^8) vector dot product with four outputs.
## 
##  Vector dot product optimized to calculate four ouputs at a time. Does four
...
proc gf_4vect_dot_prod_avx*(len: cint; vlen: cint; gftbls: ptr cuchar;
                           src: ptr ptr cuchar; dest: ptr ptr cuchar) {.cdecl,
    importc: "gf_4vect_dot_prod_avx", dynlib: libname.}
## *
##  @brief GF(2^8) vector dot product with four outputs.
## 
##  Vector dot product optimized to calculate four ouputs at a time. Does four
...
proc gf_4vect_dot_prod_avx2*(len: cint; vlen: cint; gftbls: ptr cuchar;
                            src: ptr ptr cuchar; dest: ptr ptr cuchar) {.cdecl,
    importc: "gf_4vect_dot_prod_avx2", dynlib: libname.}
## *
...
proc gf_5vect_dot_prod_sse*(len: cint; vlen: cint; gftbls: ptr cuchar;
                           src: ptr ptr cuchar; dest: ptr ptr cuchar) {.cdecl,
    importc: "gf_5vect_dot_prod_sse", dynlib: libname.}
## *
##  @brief GF(2^8) vector dot product with five outputs.
## 
##  Vector dot product optimized to calculate five ouputs at a time. Does five
...
proc gf_5vect_dot_prod_avx*(len: cint; vlen: cint; gftbls: ptr cuchar;
                           src: ptr ptr cuchar; dest: ptr ptr cuchar) {.cdecl,
    importc: "gf_5vect_dot_prod_avx", dynlib: libname.}
## *
##  @brief GF(2^8) vector dot product with five outputs.
## 
##  Vector dot product optimized to calculate five ouputs at a time. Does five
...
proc gf_5vect_dot_prod_avx2*(len: cint; vlen: cint; gftbls: ptr cuchar;
                            src: ptr ptr cuchar; dest: ptr ptr cuchar) {.cdecl,
    importc: "gf_5vect_dot_prod_avx2", dynlib: libname.}
## *
...
proc gf_6vect_dot_prod_sse*(len: cint; vlen: cint; gftbls: ptr cuchar;
                           src: ptr ptr cuchar; dest: ptr ptr cuchar) {.cdecl,
    importc: "gf_6vect_dot_prod_sse", dynlib: libname.}
## *
##  @brief GF(2^8) vector dot product with six outputs.
## 
##  Vector dot product optimized to calculate six ouputs at a time. Does six
...
proc gf_6vect_dot_prod_avx*(len: cint; vlen: cint; gftbls: ptr cuchar;
                           src: ptr ptr cuchar; dest: ptr ptr cuchar) {.cdecl,
    importc: "gf_6vect_dot_prod_avx", dynlib: libname.}
## *
##  @brief GF(2^8) vector dot product with six outputs.
## 
##  Vector dot product optimized to calculate six ouputs at a time. Does six
...
proc gf_6vect_dot_prod_avx2*(len: cint; vlen: cint; gftbls: ptr cuchar;
                            src: ptr ptr cuchar; dest: ptr ptr cuchar) {.cdecl,
    importc: "gf_6vect_dot_prod_avx2", dynlib: libname.}
## *
...
proc gf_vect_dot_prod_base*(len: cint; vlen: cint; gftbls: ptr cuchar;
                           src: ptr ptr cuchar; dest: ptr cuchar) {.cdecl,
    importc: "gf_vect_dot_prod_base", dynlib: libname.}
## *
...
proc gf_vect_dot_prod*(len: cint; vlen: cint; gftbls: ptr cuchar; src: ptr ptr cuchar;
                      dest: ptr cuchar) {.cdecl, importc: "gf_vect_dot_prod",
                                       dynlib: libname.}
## *
...
proc gf_vect_mad*(len: cint; vec: cint; vec_i: cint; gftbls: ptr cuchar; src: ptr cuchar;
                 dest: ptr cuchar) {.cdecl, importc: "gf_vect_mad", dynlib: libname.}
## *
...
proc gf_vect_mad_sse*(len: cint; vec: cint; vec_i: cint; gftbls: ptr cuchar;
                     src: ptr cuchar; dest: ptr cuchar) {.cdecl,
    importc: "gf_vect_mad_sse", dynlib: libname.}
## *
##  @brief GF(2^8) vector multiply accumulate, arch specific version.
## 
##  Arch specific version of gf_vect_mad() with same parameters.
...
proc gf_vect_mad_avx*(len: cint; vec: cint; vec_i: cint; gftbls: ptr cuchar;
                     src: ptr cuchar; dest: ptr cuchar) {.cdecl,
    importc: "gf_vect_mad_avx", dynlib: libname.}
## *
##  @brief GF(2^8) vector multiply accumulate, arch specific version.
## 
##  Arch specific version of gf_vect_mad() with same parameters.
...
proc gf_vect_mad_avx2*(len: cint; vec: cint; vec_i: cint; gftbls: ptr cuchar;
                      src: ptr cuchar; dest: ptr cuchar) {.cdecl,
    importc: "gf_vect_mad_avx2", dynlib: libname.}
## *
...
proc gf_vect_mad_base*(len: cint; vec: cint; vec_i: cint; v: ptr cuchar; src: ptr cuchar;
                      dest: ptr cuchar) {.cdecl, importc: "gf_vect_mad_base",
                                       dynlib: libname.}
## *
...
proc gf_2vect_mad_sse*(len: cint; vec: cint; vec_i: cint; gftbls: ptr cuchar;
                      src: ptr cuchar; dest: ptr ptr cuchar) {.cdecl,
    importc: "gf_2vect_mad_sse", dynlib: libname.}
## *
##  @brief GF(2^8) vector multiply with 2 accumulate. AVX version of gf_2vect_mad_sse().
##  @requires AVX
## 

proc gf_2vect_mad_avx*(len: cint; vec: cint; vec_i: cint; gftbls: ptr cuchar;
                      src: ptr cuchar; dest: ptr ptr cuchar) {.cdecl,
    importc: "gf_2vect_mad_avx", dynlib: libname.}
## *
##  @brief GF(2^8) vector multiply with 2 accumulate. AVX2 version of gf_2vect_mad_sse().
##  @requires AVX2
## 

proc gf_2vect_mad_avx2*(len: cint; vec: cint; vec_i: cint; gftbls: ptr cuchar;
                       src: ptr cuchar; dest: ptr ptr cuchar) {.cdecl,
    importc: "gf_2vect_mad_avx2", dynlib: libname.}
## *
...
proc gf_3vect_mad_sse*(len: cint; vec: cint; vec_i: cint; gftbls: ptr cuchar;
                      src: ptr cuchar; dest: ptr ptr cuchar) {.cdecl,
    importc: "gf_3vect_mad_sse", dynlib: libname.}
## *
##  @brief GF(2^8) vector multiply with 3 accumulate. AVX version of gf_3vect_mad_sse().
##  @requires AVX
## 

proc gf_3vect_mad_avx*(len: cint; vec: cint; vec_i: cint; gftbls: ptr cuchar;
                      src: ptr cuchar; dest: ptr ptr cuchar) {.cdecl,
    importc: "gf_3vect_mad_avx", dynlib: libname.}
## *
##  @brief GF(2^8) vector multiply with 3 accumulate. AVX2 version of gf_3vect_mad_sse().
##  @requires AVX2
## 

proc gf_3vect_mad_avx2*(len: cint; vec: cint; vec_i: cint; gftbls: ptr cuchar;
                       src: ptr cuchar; dest: ptr ptr cuchar) {.cdecl,
    importc: "gf_3vect_mad_avx2", dynlib: libname.}
## *
...
proc gf_4vect_mad_sse*(len: cint; vec: cint; vec_i: cint; gftbls: ptr cuchar;
                      src: ptr cuchar; dest: ptr ptr cuchar) {.cdecl,
    importc: "gf_4vect_mad_sse", dynlib: libname.}
## *
##  @brief GF(2^8) vector multiply with 4 accumulate. AVX version of gf_4vect_mad_sse().
##  @requires AVX
## 

proc gf_4vect_mad_avx*(len: cint; vec: cint; vec_i: cint; gftbls: ptr cuchar;
                      src: ptr cuchar; dest: ptr ptr cuchar) {.cdecl,
    importc: "gf_4vect_mad_avx", dynlib: libname.}
## *
##  @brief GF(2^8) vector multiply with 4 accumulate. AVX2 version of gf_4vect_mad_sse().
##  @requires AVX2
## 

proc gf_4vect_mad_avx2*(len: cint; vec: cint; vec_i: cint; gftbls: ptr cuchar;
                       src: ptr cuchar; dest: ptr ptr cuchar) {.cdecl,
    importc: "gf_4vect_mad_avx2", dynlib: libname.}
## *
##  @brief GF(2^8) vector multiply with 5 accumulate. SSE version.
##  @requires SSE4.1
## 

proc gf_5vect_mad_sse*(len: cint; vec: cint; vec_i: cint; gftbls: ptr cuchar;
                      src: ptr cuchar; dest: ptr ptr cuchar) {.cdecl,
    importc: "gf_5vect_mad_sse", dynlib: libname.}
## *
##  @brief GF(2^8) vector multiply with 5 accumulate. AVX version.
##  @requires AVX
## 

proc gf_5vect_mad_avx*(len: cint; vec: cint; vec_i: cint; gftbls: ptr cuchar;
                      src: ptr cuchar; dest: ptr ptr cuchar) {.cdecl,
    importc: "gf_5vect_mad_avx", dynlib: libname.}
## *
##  @brief GF(2^8) vector multiply with 5 accumulate. AVX2 version.
##  @requires AVX2
## 

proc gf_5vect_mad_avx2*(len: cint; vec: cint; vec_i: cint; gftbls: ptr cuchar;
                       src: ptr cuchar; dest: ptr ptr cuchar) {.cdecl,
    importc: "gf_5vect_mad_avx2", dynlib: libname.}
## *
##  @brief GF(2^8) vector multiply with 6 accumulate. SSE version.
##  @requires SSE4.1
## 

proc gf_6vect_mad_sse*(len: cint; vec: cint; vec_i: cint; gftbls: ptr cuchar;
                      src: ptr cuchar; dest: ptr ptr cuchar) {.cdecl,
    importc: "gf_6vect_mad_sse", dynlib: libname.}
## *
##  @brief GF(2^8) vector multiply with 6 accumulate. AVX version.
##  @requires AVX
## 

proc gf_6vect_mad_avx*(len: cint; vec: cint; vec_i: cint; gftbls: ptr cuchar;
                      src: ptr cuchar; dest: ptr ptr cuchar) {.cdecl,
    importc: "gf_6vect_mad_avx", dynlib: libname.}
## *
##  @brief GF(2^8) vector multiply with 6 accumulate. AVX2 version.
##  @requires AVX2
## 

proc gf_6vect_mad_avx2*(len: cint; vec: cint; vec_i: cint; gftbls: ptr cuchar;
                       src: ptr cuchar; dest: ptr ptr cuchar) {.cdecl,
    importc: "gf_6vect_mad_avx2", dynlib: libname.}
## *********************************************************************
...
proc gf_mul*(a: cuchar; b: cuchar): cuchar {.cdecl, importc: "gf_mul", dynlib: libname.}
## *
...
proc gf_inv*(a: cuchar): cuchar {.cdecl, importc: "gf_inv", dynlib: libname.}
## *
...
proc gf_gen_rs_matrix*(a: ptr cuchar; m: cint; k: cint) {.cdecl,
    importc: "gf_gen_rs_matrix", dynlib: libname.}
## *
...
proc gf_gen_cauchy1_matrix*(a: ptr cuchar; m: cint; k: cint) {.cdecl,
    importc: "gf_gen_cauchy1_matrix", dynlib: libname.}
## *
...
proc gf_invert_matrix*(`in`: ptr cuchar; `out`: ptr cuchar; n: cint): cint {.cdecl,
    importc: "gf_invert_matrix", dynlib: libname.}
## ***********************************************************
